...
@section('content')
    <div class="flex justify-center">
        <div class="w-full max-w-lg">
            <div class="card bg-white border border-info shadow-xl flex flex-col h-[500px]  position: absolute;"
                style="border: 4px solid #718096 ">
                    ...
                    <div class="mx-auto my-10">
                                ...
                                @foreach (explode('|', $admin->images) as $image)
                                    <div class="avatar mx-2">
                                        <div
                                            ...
                                            <img src="{{ asset($image) }}" alt="I am A Pic"
                        ...
                        <div class="bg-white border rounded-md shadow-lg p-5 mt-7" style="border: 2px solid #718096">
                            <div class="flex flex-col space-y-2">
                                <div class="font-inter-bold font-bold" id="spam">ID: <span
                                        style="color:#28BD5F">{{ $admin->id }}</span></div>
                                <div class="font-inter-bold font-bold" id="spam">Role: <span
                                        style="color:#28BD5F">{{ $admin->role }}</span></div>
                                <div class="font-inter-bold font-bold" id="spam">User ID: <span
                                        style="color:#28BD5F">{{ $admin->user_id }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
